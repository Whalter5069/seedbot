...
def art():
    print(f"{Fore.LIGHTRED_EX}" + r"H   H  U   U  N   N  TTTTT  EEEEE  RRRR  " + f"{Style.RESET_ALL}")
    print(f"{Fore.GREEN}" + r"H   H  U   U  NN  N    T    E      R   R " + f"{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}" + r"HHHHH  U   U  N N N    T    EEEE   RRRR  " + f"{Style.RESET_ALL}")
    print(f"{Fore.LIGHTRED_EX}" + r"H   H  U   U  N  NN    T    E      R R   " + f"{Style.RESET_ALL}")
    print(f"{Fore.GREEN}" + r"H   H   UUU   N   N    T    EEEEE  R  RR " + f"{Style.RESET_ALL}")

    print(f"{Fore.CYAN + Style.BRIGHT}Join our Telegram: https://t.me/team_hunters0{Style.RESET_ALL}\n")
...
def draw_tree():
    tree = f"""
        {Fore.GREEN}                       Hunter
          ...
          HunterHunterHunterHunterHunterHunter
        HunterHunterHunterHunterHunterHunterHunter
